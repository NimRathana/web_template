      ...
      <Container>
        ...
        <Box sx={{ 
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Avatar sx={{ bgcolor: primaryColor, width: 40, height: 40 }}>B</Avatar>
          </Stack>
        </Box>
                ...
                <Grid container spacing={6} sx={{ pt: 3 }}>
                  ...
                  <Grid size={12}>
                    <Stack direction="row" spacing={3} flexWrap="wrap">
                      <Button variant="contained" startIcon={<AddIcon />} size="large" sx={{ borderRadius: 2, px: 5, textTransform: 'none', fontWeight: 600, bgcolor: primaryColor }} onClick={() => setDialogOpen(true)}>
                        Create New
                      </Button>
                      <Button variant="outlined" size="large" sx={{ borderRadius: 2, px: 5, textTransform: 'none', fontWeight: 600 }}>
                        Preview Changes
                      </Button>
                      <Fab color="primary" size="medium" onClick={() => setDialogOpen(true)} sx={{ boxShadow: 4 }}>
                        <AddIcon />
                      </Fab>
                    </Stack>
                  </Grid>
